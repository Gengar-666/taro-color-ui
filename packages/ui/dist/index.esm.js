...
import { Button, Text, View, Image, Block, Swiper, SwiperItem, ScrollView } from '@tarojs/components';
...
var CuButton = function (_a) {
    ...
    var IS_WEB = Taro.getEnv() === Taro.ENV_TYPE.WEB;
    var props = IS_WEB
        ? {
            lang: lang,
            formType: formType
    ...
    return (React.createElement(Button, __assign({ onClick: handleClick, className: wrapCls }, props, { style: Object.assign(customColorStyle(), customStyle) }),
...
var ListItem = function (_a) {
    ...
    var _c = __read(React.useState({}), 2), touchInfo = _c[0], setTouchInfo = _c[1];
...
var CuTag = function (_a) {
    ...
    var capsuleCls = type === "capsule"
        ...
        : "";
    var tag = (React.createElement(View, { className: wrapCls, onClick: onClick }, children));
    var capsuleTag = (React.createElement(View, { className: capsuleCls, onClick: onClick },
...
CuAvatar.Group = function (_a) {
    ...
    return (React.createElement(View, { className: "cu-avatar-group" }, children));
};
...
var CuSwitch = function (_a) {
    ...
    var setStateCallback = useRef();
    var _g = __read(useState(checked), 2), _checked = _g[0], set_Checked = _g[1];
    useEffect(function () {
    ...
    return (React.createElement(View, { className: wrapCls, style: { backgroundColor: _checked ? color : "#8799a3" } },
        React.createElement(View, { className: "fui-switch", style: {
            ...
            }, onClick: switchState }, showIcon && (React.createElement(CuIcon, { value: _checked ? "check" : "close", color: "#fff", size: "12" })))));
};
...
var CuTimelineItem$1 = function (_a) {
    ...
    return (React.createElement(View, { className: classnames("cu-item", (_b = {},
...
var CuModal = function (_a) {
    ...
    var _g = __read(React.useState(isOpened), 2), _isOpened = _g[0], setOpened = _g[1];
...
var CuGrid = function (_a) {
    ...
    return (React.createElement(View, { className: classnames("grid", "col-" + columnNum, className, {
            "no-border": !border
        }) }, data.map(function (item, index) { return (React.createElement(View, { className: "cu-item", key: index, onClick: function () {
...
var CuSwiper = function (_a) {
    ...
    var _e = __read(React.useState(0), 2), currentIndex = _e[0], setCurrentIndex = _e[1];
    ...
    return (React.createElement(Swiper, __assign({ className: classnames("cu-swiper", type + "-swiper", dotStyle) }, swiperProps, { onChange: onChange }), images.map(function (src, index) { return (React.createElement(SwiperItem, { className: classnames("cu-swiper-item", {
...
var CuTabs = function (_a) {
    ...
    var _o = __read(React.useState(current), 2), tabCur = _o[0], setTabCur = _o[1];
    var _p = __read(React.useState(0), 2), srollLeft = _p[0], setSrollLeft = _p[1];
    /** 判断是不是第一次渲染组件 */
    ...
    var tabItemNode = (React.createElement(React.Fragment, null, tabs.map(function (item, index) { return (React.createElement(View, { className: classnames("cu-item", {
            cur: tabCur === index
        }), style: Object.assign({
    ...
    return (React.createElement(View, null,
        ...
        swipeable && (React.createElement(Swiper, { current: tabCur, duration: animated ? 300 : 0, easingFunction: easingFunction, onChange: function (e) { return tabSelect(e.detail.current); }, style: { height: height } }, tabItems.map(function (item) { return (React.createElement(SwiperItem, { key: item.key, className: "cu-tabs-pane", style: { height: height } }, item)); }))),
        !swipeable &&
            tabItems.map(function (item, index) { return (React.createElement(React.Fragment, { key: item.key }, index === tabCur && (React.createElement(View, { className: "cu-tabs-pane", style: { height: height } }, item)))); })));
};
...
var CuNavigation = function (_a) {
    ...
    return (React.createElement(View, { className: "cu-custom", style: { height: style.height } },
        React.createElement(View, { className: "cu-bar fixed", style: style },
            React.createElement(View, { className: "action", onClick: function () { return (isBack ? Taro.navigateBack({ delta: 1 }) : void 0); } },
...
export { CuAvatar, CuButton, CuGrid, CuIcon, CuList, CuModal, CuNavigation, CuProgress, CuSteps, CuSwiper, CuSwitch, CuTabs, CuTag, CuTimeline };
